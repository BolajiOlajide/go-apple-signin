...
GoLang wrapper around [Sign in with Apple REST API](https://developer.apple.com/documentation/signinwithapplerestapi).
It provides helper functionality around apple's authentication mechanism for Go.

This module lets you authenticate users using Apple account in your go application.
...
```sh
go get github.com/BolajiOlajide/go-apple-signin
```
...
```go
import "github.com/BolajiOlajide/go-apple-signin"
